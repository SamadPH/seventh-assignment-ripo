  ...
  const showProducts = (products) => {
    for (const product of products) {
      ...
      <div class="single-product">
        ...
        <h6>${product.title}</h6>
        <p class="text-warning fw-bold">Category: ${product.category}</p>
